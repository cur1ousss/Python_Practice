...
# Length of Dict >> number of Keys
print(len(dict1))

print(student.keys())	# prints only the Keys
print(student.values())	# prints only the Values

print(student.items())	# Prints Key and Value Pairs in (),() form

# Looping through
for key in student:	# by default Loops through Keys only not values printed
	print(key)
