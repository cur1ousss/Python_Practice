...
# before python runs any code file it first goes through and sets a few special variables which __name__ is a part of 
    # and when python runs a file directly it sets __name__ = __main__ 


        # FILE - secondModule.py
# when we import module __name__ is set to name of module 
import first_module
    # whenever we import a module its code is run 
    # so OP in this case will be name of module, since whenever import a module containing __name__ its name is set to name of file 
